...
def save_visualizations(img_path, img, gt_boxes, full_preds, stage3_preds, class_names):
    ...
    # GT 시각화
    draw_boxes_on_image(
        img, gt_boxes, class_names,
        save_path=os.path.join(save_dir, "gt.png"),
        title="Ground Truth"
    )

    # Full Inference 시각화
    draw_boxes_on_image(
        img, full_preds, class_names,
        save_path=os.path.join(save_dir, "full_pred.png"),
        title="Full Image Prediction"
    )

    # Stage3 시각화
    draw_boxes_on_image(
        img, stage3_preds, class_names,
        save_path=os.path.join(save_dir, "stage3_pred.png"),
        title="3-Stage Prediction"
    )
